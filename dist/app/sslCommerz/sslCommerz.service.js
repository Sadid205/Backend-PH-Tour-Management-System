...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new AppErrors_1.default(http_status_codes_1.default.BAD_REQUEST, error.message);
    }
});
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, axios_1.default)({
            method: "GET",
            url: `${env_1.envVars.SSL.SSL_VALIDATION_API}?val_id=${payload.val_id}&stor_id=${env_1.envVars.SSL.STORE_ID}&store_passwd=${env_1.envVars.SSL.STORE_PASS}`,
        });
        console.log("sslcommerz validate api response", response.data);
        yield payment_model_1.Payment.updateOne({ transactionId: payload.tran_id }, {
            paymentGatwayData: response.data,
        }, { runValidators: true });
    }
    catch (error) {
        console.log(error);
        throw new AppErrors_1.default(401, `Payment validation Error,: ${error.message}`);
    }
});
exports.SSLService = {
    sslPaymentInit,
