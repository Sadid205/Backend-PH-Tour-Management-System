...
const createBooking = (payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!(user === null || user === void 0 ? void 0 : user.phone) || !user.address) {
            throw new AppErrors_1.default(http_status_codes_1.default.BAD_REQUEST, "Please Update Your Profile to Book a Tour");
        }
        const tour = yield tour_model_1.Tour.findById(payload.tour).select("costForm");
        if (!(tour === null || tour === void 0 ? void 0 : tour.costForm)) {
            throw new AppErrors_1.default(http_status_codes_1.default.BAD_REQUEST, "No Tour Cost Found!");
        }
