...
divisionSchema.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (this.isModified("name")) {
            const slugText = (_a = this.name) === null || _a === void 0 ? void 0 : _a.split(" ").join("-").toLowerCase();
...
divisionSchema.pre("findOneAndUpdate", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (division.name) {
            const slugText = (_a = division.name) === null || _a === void 0 ? void 0 : _a.split(" ").join("-").toLowerCase();
            let slug = `${slugText}-division`;
            let counter = 0;
            while (yield exports.Division.exists({ slug: slug })) {
                slug = `${slug}-${counter++}`;
